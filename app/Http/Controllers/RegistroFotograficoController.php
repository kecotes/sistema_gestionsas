...
class RegistroFotograficoController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      return view('registrofotografico.index',["registrofotografico"=>$registrofotografico,"contratosADM"=>$contratosADM,"contratosRdt"=>$contratosRdt,"contratoid"=>$contratoid,"query"=>$query,"contratosh1"=>$contratosh1,"idusers"=>$idusers,"users"=>$users]);
    }
     ...
     * @return Response
     */
    public function createregistrofotografico($idcontrato)
    {
        // Obtiene el ID del Usuario Autenticado
        $idusers = Auth::id();
        $idactividad=10;
		...
		return view("registrofotografico.createregistrofotografico",["idcontrato"=>$idcontrato,"informesADM"=>$informesADM,"informesRdt"=>$informesRdt,"residentes"=>$residentes]);
    }
    ...
    public function store(CreateActividadescontratosRequest $request)
    {
        ...
        $nombre=$request->get("name");
            ...
            Flash::success('Registro Fotografico Agregado Satisfatoriamente.');
    ...
    public function show($id)
    {
        ...
        return view('registrofotografico.show')->with('actividadescontratos', $actividadescontratos);
    }
    ...
    public function edit($id)
    {
        ...
        $registrofotografico=DB::table('actividadescontratos as ac')
		...
		return view("registrofotografico.edit",["registrofotografico"=>$registrofotografico,"contratosRdt"=>$contratosRdt,"contratos"=>$contratos,"idusers"=>$idusers,"residentes"=>$residentes]);
    ...
    public function update($id, UpdateActividadescontratosRequest $request)
    {
        ...
        Flash::success('Registro Fotografico actualizada.');

        return redirect(route('registrofotografico.index'));
    }

    public function registrofoto($id){
