...
class EjefisicofinancierasController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        ->orderBy('ac.id','desc')
        ->paginate(7);
        //*va a tocar volver a crear dos consultas para admin y residente, ya que el admin nesesita poder consultar hasta el usuario que tiene ese contrato, jja no toco
      ...
      ->join('contratos as c','c.id','=','usc.idcontratos')->select('c.id','c.created_at')->where('u.id','=',$idusers)->whereNull('c.deleted_at')->latest()->first();
        return view('ejefisicofinancieras.index',["ejefisicofinancieras"=>$ejefisicofinancieras,"contratosADM"=>$contratosADM,"contratosRdt"=>$contratosRdt,"contratoid"=>$contratoid,"query"=>$query,"idusers"=>$idusers,"users"=>$users]);
     ...
     * @return Response
     */
    public function createejefisicofinancieras($idcontrato)
    {
        // Obtiene el ID del Usuario Autenticado
        $idusers = Auth::id();
        $idactividad=10;
		...
		return view("ejefisicofinancieras.createejefisicofinancieras",["idcontrato"=>$idcontrato,"informesADM"=>$informesADM,"informesRdt"=>$informesRdt,"residentes"=>$residentes]);
    }
    ...
    public function store(CreateActividadescontratosRequest $request)
    {
        ...
        $nombre=$request->get("name");
            ...
            return redirect(route('ejefisicofinancieras.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('ejefisicofinancieras.show')->with('actividadescontratos', $actividadescontratos);
    }
    ...
    public function edit($id)
    {
        ...
        $ejefisicofinancieras=DB::table('actividadescontratos as ac')
		...
		return view("ejefisicofinancieras.edit",["ejefisicofinancieras"=>$ejefisicofinancieras,"contratosRdt"=>$contratosRdt,"contratos"=>$contratos,"idusers"=>$idusers,"residentes"=>$residentes]);
    }
    ...
    public function update($id, UpdateArchivosactividadescontratosRequest $request)
    {
        ...
        Flash::success('Ejecucion fisico financiera actualizada.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Ejecucion fisico financiera Eliminada.');
