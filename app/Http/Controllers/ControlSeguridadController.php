...
class ControlSeguridadController extends Controller
{
    ...
    public function store(CreateActividadescontratosRequest $request)
    {
        ...
        Flash::success('Control Seguridad Agregado Satisfatoriamente..');
    ...
    public function show($id)
    {
        ...
        return view('controlseguridad.show')->with('actividadescontratos', $actividadescontratos);
    }
    ...
    public function edit($id)
    {
        ...
        $controlseguridad=DB::table('actividadescontratos as ac')
        ...
        return view("controlseguridad.edit",["controlseguridad"=>$controlseguridad,"contratosRdt"=>$contratosRdt,"contratos"=>$contratos,"idusers"=>$idusers,"residentes"=>$residentes]);
    }
    ...
    public function update($id, UpdateActividadescontratosRequest $request)
    {
        ...
        Flash::success('Control Seguridad actualizada.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Control Seguridd Eliminado.');
