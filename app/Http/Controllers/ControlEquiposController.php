...
class ControlEquiposController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $controlequipos=DB::table('personas as p')
      ...
      $ultimaVersion=DB::table('contratos as c')
        ->join('actividadescontratos as ac','c.id','=','ac.idcontratos')
        ->join('archivosactividadescontratos as aac','ac.id','=','aac.idactividadescontratos')->select('aac.id','aac.descripcion','aac.created_at','ac.idtipoactividades','ac.idcontratos')->where('aac.descripcion','=','admin')->latest()->first();

      return view('controlequipos.index',["controlequipos"=>$controlequipos,"contratosADM"=>$contratosADM,"contratosRdt"=>$contratosRdt,"ultimaVersion"=>$ultimaVersion,"searchText"=>$query,"contratosh1"=>$contratosh1,"idusers"=>$idusers,"users"=>$users]);
    }
    ...
    public function create()
    {
        ...
        $idactividad=1;
		return view("controlequipos.create",["contratosRdt"=>$contratosRdt,"contratosADM"=>$contratosADM,"idactividad"=>$idactividad,"residentes"=>$residentes]);
    }
    ...
    public function show($id)
    {
        ...
        return view('controlequipos.show')->with('actividadescontratos', $actividadescontratos);
    }
    ...
    public function edit($id)
    {
        ...
        $controlequipos=DB::table('actividadescontratos as ac')
		...
		return view("controlequipos.edit",["controlequipos"=>$controlequipos,"contratosRdt"=>$contratosRdt,"contratos"=>$contratos,"idusers"=>$idusers,"residentes"=>$residentes]);
