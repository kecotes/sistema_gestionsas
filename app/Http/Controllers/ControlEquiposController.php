...
class ControlEquiposController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      return view('controlequipos.index',["controlequipos"=>$controlequipos,"contratosADM"=>$contratosADM,"contratosRdt"=>$contratosRdt,"contratoid"=>$contratoid,"query"=>$query,"contratosh1"=>$contratosh1,"idusers"=>$idusers,"users"=>$users]);
    }
     ...
     * @return Response
     */
    public function createcontrolequipos($idcontrato)
    {
        // Obtiene el ID del Usuario Autenticado
        $idusers = Auth::id();
        $idactividad=10;
		...
		return view("controlequipos.createcontrolequipos",["idcontrato"=>$idcontrato,"informesADM"=>$informesADM,"informesRdt"=>$informesRdt,"residentes"=>$residentes]);
    }
