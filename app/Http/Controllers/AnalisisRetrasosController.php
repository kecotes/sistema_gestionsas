...
class AnalisisRetrasosController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      return view('analisisretrasos.index',["analisisretrasos"=>$analisisretrasos,"contratosADM"=>$contratosADM,"contratosRdt"=>$contratosRdt,"ultimaVersion"=>$ultimaVersion,"searchText"=>$query,"contratosh1"=>$contratosh1,"idusers"=>$idusers,"users"=>$users]);
    }
    ...
    public function create()
    {
        ...
        $idactividad=6;
		return view("analisisretrasos.create",["contratosRdt"=>$contratosRdt,"contratosADM"=>$contratosADM,"idactividad"=>$idactividad,"residentes"=>$residentes]);
    }
