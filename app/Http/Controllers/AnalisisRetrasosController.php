...
class AnalisisRetrasosController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $analisisretrasos=DB::table('personas as p')
      ...
      return view('analisisretrasos.index',["analisisretrasos"=>$analisisretrasos,"contratosADM"=>$contratosADM,"contratosRdt"=>$contratosRdt,"contratoid"=>$contratoid,"query"=>$query,"contratosh1"=>$contratosh1,"idusers"=>$idusers,"users"=>$users]);
    }
     ...
     * @return Response
     */
    public function createanalisisretrasos($idcontrato)
    {
        // Obtiene el ID del Usuario Autenticado
        $idusers = Auth::id();
        $idactividad=10;
		...
		return view("analisisretrasos.createanalisisretrasos",["idcontrato"=>$idcontrato,"informesADM"=>$informesADM,"informesRdt"=>$informesRdt,"residentes"=>$residentes]);
    }
    ...
    public function store(CreateActividadescontratosRequest $request)
    {
        ...
        $nombre=$request->get("name");
            ...
            return redirect(route('analisisretrasos.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('analisisretrasos.show')->with('actividadescontratos', $actividadescontratos);
    }
    ...
    public function edit($id)
    {
        ...
        $analisisretrasos=DB::table('actividadescontratos as ac')
		...
		return view("analisisretrasos.edit",["analisisretrasos"=>$analisisretrasos,"contratosRdt"=>$contratosRdt,"contratos"=>$contratos,"idusers"=>$idusers,"residentes"=>$residentes]);
