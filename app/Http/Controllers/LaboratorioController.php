...
class LaboratorioController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $laboratorios=DB::table('personas as p')
    ...
    public function store(CreateActividadescontratosRequest $request)
    {
        ...
        if($archivo != null) {
            ...
            Flash::success('Registro Agregado Satisfatoriamente.');
    ...
    public function show($id)
    {
        ...
        return view('laboratorios.show')->with('actividadescontratos', $actividadescontratos);
    }
    ...
    public function edit($id)
    {
        ...
        $laboratorios=DB::table('actividadescontratos as ac')
		...
		return view("laboratorios.edit",["laboratorios"=>$laboratorios,"contratosRdt"=>$contratosRdt,"contratos"=>$contratos,"idusers"=>$idusers,"residentes"=>$residentes]);
