...
class EstadoTiempoController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      return view('estadotiempo.index',["estadotiempo"=>$estadotiempo,"contratosADM"=>$contratosADM,"contratosRdt"=>$contratosRdt,"ultimaVersion"=>$ultimaVersion,"searchText"=>$query,"contratosh1"=>$contratosh1,"idusers"=>$idusers,"users"=>$users]);
    }
    ...
    public function create()
    {
        ...
        $idactividad=4;
		return view("estadotiempo.create",["contratosRdt"=>$contratosRdt,"contratosADM"=>$contratosADM,"idactividad"=>$idactividad,"residentes"=>$residentes]);
    }
