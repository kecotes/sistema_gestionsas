<table class="table table-hover">
                ...
                <!-- Novedades Fechas-->
                <?php $__currentLoopData = $novedadesfechas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $novedadesfechas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    echo '<tr>';
          ...
          <!-- Polizas -->
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <tbody>
                <?php $__currentLoopData = $polizas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $polizas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                  
        ...
        <div class="box-header">
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <tbody>
                <?php $__currentLoopData = $estadospolizas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estadospolizas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                  
        ...
        <div class="box-header">
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <tbody>
                <?php $__currentLoopData = $correspondenciasEnviada; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $correspondencias): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <tbody>
                <?php $__currentLoopData = $correspondenciasRecibida; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $correspondencias): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                               
                    <td><p><?php echo $correspondencias->fecha; ?></p></td>
                    <td><p><?php echo $correspondencias->destinatario; ?></p></td>
                    <td><p><?php echo $correspondencias->remitente; ?></p></td>
                    <td><p><?php echo $correspondencias->asunto; ?></p></td>
            ...
            <div class="box-header">
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <tr>
                    ...
                    <td><p><?php echo $contratos->valoranticipoadicional; ?></p></td>
                <tr>
                <?php $__currentLoopData = $balancesfinancieros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balancesfinancieros): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
             ...
             <div class="box-header">
              ...
              <?php $__currentLoopData = $archivoscontratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archivoscontratos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <ul>
          ...
          <br><br><br>
            ...
            <div class="box-header">
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <tbody>
                <?php $__currentLoopData = $actividadescontratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividadescontratos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
