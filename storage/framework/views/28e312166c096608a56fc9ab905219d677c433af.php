...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo e(url('/home')); ?>"><b>Gestion </b>Negocios SAS</a>
    </div>

    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Inicie session para ingresar al sistema</p>
        ...
        <a href="<?php echo e(url('/password/reset')); ?>">Olvide la contraseña</a><br>
