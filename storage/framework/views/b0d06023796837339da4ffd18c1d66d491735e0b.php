<?php $__env->startSection('content'); ?>
    <section class="content-header">
      <h1>Registro Fotografico <a class="btn btn-success" href="<?php echo route('registrofotografico.create'); ?>">Nuevo</a> <?php if($contratoid != null): ?> <a class="btn btn-info" href="descargarRfV/<?php echo e($contratoid->id); ?>">Descargar ultima version</a> <?php endif; ?>
        <small></small>
      </h1>
