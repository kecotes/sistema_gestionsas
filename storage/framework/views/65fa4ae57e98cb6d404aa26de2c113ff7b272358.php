<?php $__env->startSection('content'); ?>
    <section class="content-header">
      <h1>Estado de Tiempo <a class="btn btn-success" href="<?php echo route('estadotiempo.create'); ?>">Nuevo</a><a class="btn btn-info" href="descargarEjeV/<?php echo e($ultimaVersion->id); ?>">Descargar ultima version</a>
        <small></small>
      </h1>
