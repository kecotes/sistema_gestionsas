...
<div class="form-group col-sm-6">
    ...
    <select name="identidadescontratantes" class="form-control">
        <?php $__currentLoopData = $entidadescontratantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entidadescontratantes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="form-group col-sm-6">
    ...
    <select name="idcontratista" class="form-control">
        <?php $__currentLoopData = $contratista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contratista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="form-group col-sm-6">
    ...
    <select name="representante" class="form-control">
        <?php $__currentLoopData = $representante; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $representante): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="form-group col-sm-6">
    ...
    <select name="idunionestemporales" multiple class="form-control">
        <?php $__currentLoopData = $unionestemporales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unionestemporales): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="form-group col-sm-6">
    ...
    <select name="idtiposcontratos" class="form-control">
        <?php $__currentLoopData = $tiposcontratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tiposcontratos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
