        ...
        <!-- Balance Financiero -->
            ...
            <div class="box-header">
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <thead>
                <tr>
                  <th bgcolor="#82E0AA">Acta Parcial</th>
                  <th bgcolor="#82E0AA">Pendiente por Pagar</th>
                  <th bgcolor="#82E0AA">Estado</th>
                </thead>
                <tbody>
                <?php $__currentLoopData = $balancesfinancieros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balancesfinancieros): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>                  
                    ...
                    <td><p><?php echo $balancesfinancieros->pendientepagar; ?></p></td>
                    <td><p><?php echo $balancesfinancieros->estado; ?></p></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                </tbody>
                </table>
            ...
            <!-- Archivos Contratos -->
              ...
              <?php $__currentLoopData = $archivoscontratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archivoscontratos): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?> 
                  <a href="descargar/<?php echo e($archivoscontratos->id); ?>"  target="_blank"><button class="btn  btn-info btn-xs">Descargar</button></a>  
              <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
