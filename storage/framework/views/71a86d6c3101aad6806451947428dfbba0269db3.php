...
<?php if(Auth::user()->tipoUsuario == '1'): ?>
    ...
    <div class="form-group col-sm-6">
        ...
        <?php echo Form::select('decision', ['archivo' => 'Subir Archivo Actividad Seguimiento', 'formato' => 'Subir Archivo Formato inicial','informe' => 'Crear Informe Nuevo'], null, ['class' => 'form-control']); ?>
