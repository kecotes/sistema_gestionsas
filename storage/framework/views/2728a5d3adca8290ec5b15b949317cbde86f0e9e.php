...
<table class="table table-responsive" id="contratos-table">
    ...
    <tbody>
    <?php $__currentLoopData = $contratosRdt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contratosRdt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
