<table class="table table-responsive" id="usuarioscontratados-table">
    ...
    <tbody>
    <?php $__currentLoopData = $usuarioscontratados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuarioscontratados): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
