...
<!-- Tipopjuridica Field -->
<div class="form-group col-sm-6">
    <?php echo Form::label('tipopjuridica', 'Tipo de ppersona juridica:'); ?>

    <?php echo Form::select('tipopjuridica', ['contratista' => 'Contratista', 'representante' => 'Representante legal', 'empresa' => 'Empresa'], null, ['class' => 'form-control']); ?>
...
<div class="form-group col-sm-12">
    ...
    <a href="<?php echo route('pjuridicas.index'); ?>" class="btn btn-default">Cancel</a>
</div>
