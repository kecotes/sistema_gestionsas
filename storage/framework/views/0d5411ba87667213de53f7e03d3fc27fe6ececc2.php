<ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo route('usuarioscontratados.index'); ?>"><i class="fa fa-circle-o"></i> Personal Contratado</a></li>
            ...
            <li>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo route('balancesfinancieros.index'); ?>"><i class="fa fa-circle-o"></i> Balance Financiero</a></li>
                </ul>
            </li>
