  ...
  <ul class="treeview-menu">
    ...
    <li>
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="<?php echo route('balancesfinancieros.index'); ?>"><i class="fa fa-money"></i> Actas Parciales</a></li>
        </ul>
    </li>
...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    ...
    <li><a href="<?php echo route('residentes.index'); ?>"><i class="fa fa-user"></i> Residentes</a></li>
