...
<div class="form-group col-sm-10">
    {!! Form::label('valor', 'Valor:', ['class' => 'col-lg-2 control-label']) !!}
     <div class="col-lg-8">
    {!! Form::text('valor', null, ['class' => 'form-control', 'placeholder '=>'Insertar la fecha AAAA-MM-DD (Ej. 2017-12-31) ']) !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('novedadesfechas.index') !!}" class="btn btn-default">Cancel</a>
</div>
